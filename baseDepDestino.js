...
departamentoDestino.addEventListener("change",mostrarMunicipiosDestino);

function mostrarMunicipiosDestino() {
    validarDestino()
    switch (departamentoDestino.value) {
        case "16": //ALTA VERAPAZ
            municipioDestino.removeAttribute("disabled");
